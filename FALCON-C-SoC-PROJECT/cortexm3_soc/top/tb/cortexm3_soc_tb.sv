...
// apb files
`include "./apb_memory_components/apb_transaction.sv"
`include "./apb_memory_components/apb_intf.sv"
`include "./apb_memory_components/apb_monitor.sv"
`include "./apb_memory_components/apb_agent.sv"
...
module cortexm3_soc_tb();
  ...
  always @(*)  apb_vif.PADDR   = cortexm3_soc_i0.Paddr_b;
  always @(*)  apb_vif.PWDATA  = cortexm3_soc_i0.Pwdata_b;
  always @(*)  apb_vif.PWRITE  = cortexm3_soc_i0.Pwrite_b;
  always @(*)  apb_vif.PENABLE = cortexm3_soc_i0.Penable_b;
  always @(*)  apb_vif.PSEL    = cortexm3_soc_i0.Pselx_b;
  always @(*)  apb_vif.PRDATA  = cortexm3_soc_i0.Hrdata_b;
  always @(*)  apb_vif.PREADY  = cortexm3_soc_i0.Hreadyout_b;
