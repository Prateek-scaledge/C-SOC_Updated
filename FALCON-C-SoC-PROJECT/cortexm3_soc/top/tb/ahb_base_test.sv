...
function void ahb_base_test::build_phase(uvm_phase phase);
   ...
   */
  sys_cfg.env_cfg.has_scoreboard=1;
...
task ahb_base_test::run_phase(uvm_phase phase);
 ...
 `uvm_info("RESET_INFO","RESET *** CLEARED",UVM_NONE)
    /*forever begin   
      fork*/
       
          wait((cortexm3_soc_tb.cortexm3_soc_i0.cmsdk_fpga_sram_A.BRAM0['h3fc][3:0]===4'b0111)||(cortexm3_soc_tb.cortexm3_soc_i0.cmsdk_fpga_sram_A.BRAM0['h3fc][3:0]===4'b1110));
       /* begin               
          wait(cortexm3_soc_tb.cortexm3_soc_i0.cmsdk_fpga_sram_A.BRAM0['h3fc][3:0]===4'h5);  
          
          cortexm3_soc_tb.HRESETn = 0;
          `uvm_info("RESET_INFO","RESET CLEARED",UVM_NONE)
          #150 cortexm3_soc_tb.HRESETn = 1;
          cortexm3_soc_tb.cortexm3_soc_i0.cmsdk_fpga_sram_A.BRAM0['h3fc][3]=4'h8;  
          `uvm_info("RESET_INFO","RESET SET",UVM_NONE)
        end
      join_any
      disable fork;
